 ...
 *
 * @package   Contact Widget
 * @author    Risa <email@example.com>
 * @license   GPL-2.0+
 ...
 * Plugin URI:        @TODO
 * Description:       Contact Widget for inhabitent website.
 * Version:           1.0.0
 * Author:            Risa
 * Author URI:        @TODO
 * License:           GPL-2.0+
...
class Contact extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'contact_widget';
	...
	public function widget( $args, $instance ) {
		...
		$email = empty( $instance['email'] ) ? '' : apply_filters( 'weekdays', $instance['email'] );
