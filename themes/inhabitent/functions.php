...
function red_starter_scripts()
{
    ...
    wp_enqueue_style('stylesheet', get_template_directory_uri() . '/fontawsome.css');
// include custom jQuery
    ...
    wp_enqueue_script('main-javascript', get_template_directory_uri() . '/build/js/main.min.js', array(), '20151215', true);
...
if ( function_exists('register_sidebar') ) {
    ...
    register_sidebar(array(
        'name'          => 'Info sidebar',
        'id'            => 'info-sidebar',
        'description'   => 'this is a sidebar for right side.',
        'class'         => 's1',
